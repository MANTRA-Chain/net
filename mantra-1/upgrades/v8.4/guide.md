# Mainnet Upgrade Guide: From Version v8.3 to v8.4

## Overview

- **v8.4 Proposal**: [Proposal Page](https://www.mintscan.io/mantra/proposals/N/A)
- **v8.4 Upgrade Block Height**: 17449398
- **v8.4 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra/block/17449398)
- **v8.4 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v8.4.0)
- **v8.4 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v8.4.0](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
At the designated block height, Cosmovisor will automatically upgrade to version v8.4.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 17449398.
