# Mainnet Upgrade Guide: From Version v7.0.0 to v8.0.0

## Overview

- **v8.0.0 Proposal**: [Proposal Page](https://www.mintscan.io/mantra/proposals/30)
- **v8.0.0 Upgrade Block Height**: 14488888
- **v8.0.0 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra/block/14488888)
- **v8.0.0 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v8.0.0)
- **v8.0.0 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v8.0.0](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
At the designated block height, Cosmovisor will automatically upgrade to version v8.0.0.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 14488888.
