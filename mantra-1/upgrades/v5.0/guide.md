# Mainnet Upgrade Guide: From Version v4 to v5.0

## Overview

- **v5.0 Proposal**: [Proposal Page](https://www.mintscan.io/mantra/proposals/20)
- **v5.0 Upgrade Block Height**: 8618888
- **v5.0 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra/block/8618888)
- **v5.0 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v5.0.0)
- **v5.0 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v5.0.0](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
At the designated block height, Cosmovisor will automatically upgrade to version v5.0.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 8618888.
...
## 🚨 Extra EVM Configuration for v5.0 upgrade

Before upgrading to v5.0, you need to update your `app.toml` configuration file to enable EVM and JSON-RPC functionality.
