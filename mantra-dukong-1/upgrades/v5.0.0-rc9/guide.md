# Testnet Upgrade Guide: From Version v5.0.0-rc8 to v5.0.0-rc9

## Overview

- **v5.0.0-rc9 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/30)
- **v5.0.0-rc9 Upgrade Block Height**: 8408800
- **v5.0.0-rc9 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/8408800)
- **v5.0.0-rc9 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v5.0.0-rc9)
- **v5.0.0-rc9 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v5.0.0-rc9](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
```sh
upgrade_version="5.0.0-rc9"
upgrade_name="v5.0.0-rc9"
...
At the designated block height, Cosmovisor will automatically upgrade to version v5.0.0-rc9.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 8408800.
