# Testnet Upgrade Guide: From Version v8.6.0-pre.1 to v8.7.0-pre.1

## Overview

- **v8.7.0-pre.1 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/52)
- **v8.7.0-pre.1 Upgrade Block Height**: 1000
- **v8.7.0-pre.1 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/1000)
- **v8.7.0-pre.1 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v8.7.0-pre.1)
- **v8.7.0-pre.1 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v8.7.0-pre.1](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
```sh
upgrade_version="8.7.0-pre.1"
upgrade_name="v8.7.0-pre.1"
...
At the designated block height, Cosmovisor will automatically upgrade to version v8.7.0-pre.1.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 1000.
