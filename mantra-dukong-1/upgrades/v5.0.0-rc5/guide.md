# Testnet Upgrade Guide: From Version v5.0.0-rc4 to v5.0.0-rc5

## Overview

- **v5.0.0-rc5 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/26)
- **v5.0.0-rc5 Upgrade Block Height**: 7775000
- **v5.0.0-rc5 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/7775000)
- **v5.0.0-rc5 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v5.0.0-rc5)
- **v5.0.0-rc5 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v5.0.0-rc5](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
```sh
upgrade_version="5.0.0-rc5"
upgrade_name="v5.0.0-rc5"
...
At the designated block height, Cosmovisor will automatically upgrade to version v5.0.0-rc5.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 7775000.
