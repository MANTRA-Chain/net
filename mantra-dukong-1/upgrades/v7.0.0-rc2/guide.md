# Testnet Upgrade Guide: From Version v6.1.0 to v7.0.0-rc2
...
At the designated block height, Cosmovisor will automatically upgrade to version v7.0.0-rc2.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 10234888.
