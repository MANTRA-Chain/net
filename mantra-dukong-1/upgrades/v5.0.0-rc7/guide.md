# Testnet Upgrade Guide: From Version v5.0.0-rc6 to v5.0.0-rc7

## Overview

- **v5.0.0-rc7 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/28)
- **v5.0.0-rc7 Upgrade Block Height**: 8150548
- **v5.0.0-rc7 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/8150548)
- **v5.0.0-rc7 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v5.0.0-rc7)
- **v5.0.0-rc7 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v5.0.0-rc7](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
```sh
upgrade_version="5.0.0-rc7"
upgrade_name="v5.0.0-rc7"
...
At the designated block height, Cosmovisor will automatically upgrade to version v5.0.0-rc7.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 8150548.
