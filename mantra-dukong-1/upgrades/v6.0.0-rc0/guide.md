# Testnet Upgrade Guide: From Version v5.0.0-rc9 to v6.0.0-rc0

## Overview

- **v6.0.0-rc0 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/31)
- **v6.0.0-rc0 Upgrade Block Height**: 9235888
- **v6.0.0-rc0 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/9235888)
- **v6.0.0-rc0 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v6.0.0-rc0)
- **v6.0.0-rc0 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v6.0.0-rc0](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
```sh
upgrade_version="6.0.0-rc0"
upgrade_name="v6.0.0-rc0"
...
At the designated block height, Cosmovisor will automatically upgrade to version v6.0.0-rc0.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 9235888.
