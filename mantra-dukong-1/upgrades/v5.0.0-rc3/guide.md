# Testnet Upgrade Guide: From Version v5 to v5.0.0-rc3

## Overview

- **v5.0.0-rc3 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/24)
- **v5.0.0-rc3 Upgrade Block Height**: 7499300
- **v5.0.0-rc3 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/7499300)
...
```sh
upgrade_version="5.0.0-rc3"
upgrade_name="v5.0.0-rc3"
...
At the designated block height, Cosmovisor will automatically upgrade to version v5.0.0-rc3.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 7499300.
