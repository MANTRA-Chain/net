# Testnet Upgrade Guide: From Version v7.0.0-rc2 to v7.0.0-rc3

## Overview

- **v7.0.0-rc3 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/35)
- **v7.0.0-rc3 Upgrade Block Height**: 10436888
- **v7.0.0-rc3 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/10436888)
- **v7.0.0-rc3 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v7.0.0-rc3)
- **v7.0.0-rc3 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v7.0.0-rc3](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
```sh
upgrade_version="7.0.0-rc3"
upgrade_name="v7.0.0-rc3"
...
At the designated block height, Cosmovisor will automatically upgrade to version v7.0.0-rc3.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 10436888.
