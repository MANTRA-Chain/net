# Testnet Upgrade Guide: From Version v5.0.0-rc3 to v5.0.0-rc4

## Overview

- **v5.0.0-rc4 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/25)
- **v5.0.0-rc4 Upgrade Block Height**: 7680800
- **v5.0.0-rc4 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/7680800)
...
```sh
upgrade_version="5.0.0-rc4"
upgrade_name="v5.0.0-rc4"
...
At the designated block height, Cosmovisor will automatically upgrade to version v5.0.0-rc4.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 7680800.
