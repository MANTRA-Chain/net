# Testnet Upgrade Guide: From Version v7.0.0-rc3 to v8.0.0-rc2

## Overview

- **v8.0.0-rc2 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/36)
- **v8.0.0-rc2 Upgrade Block Height**: 12883888
- **v8.0.0-rc2 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/12883888)
- **v8.0.0-rc2 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v8.0.0-rc2)
- **v8.0.0-rc2 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v8.0.0-rc2](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
```sh
upgrade_version="8.0.0-rc2"
upgrade_name="v8.0.0-rc2"
...
At the designated block height, Cosmovisor will automatically upgrade to version v8.0.0-rc2.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 12883888.
