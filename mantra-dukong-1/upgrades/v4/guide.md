# Testnet Upgrade Guide: From Version v3 to v4

## Overview

- **v4 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/19)
- **v4 Upgrade Block Height**: 4263000
- **v4 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/4263000)
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 4263000.
