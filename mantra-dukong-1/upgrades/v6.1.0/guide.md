# Testnet Upgrade Guide: From Version v6.0.0-rc0 to v6.1.0

## Overview

- **v6.1.0 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/33)
- **v6.1.0 Upgrade Block Height**: 9485646
- **v6.1.0 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/9485646)
- **v6.1.0 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v6.1.0)
- **v6.1.0 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v6.1.0](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
At the designated block height, Cosmovisor will automatically upgrade to version v6.1.0.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 9485646.
