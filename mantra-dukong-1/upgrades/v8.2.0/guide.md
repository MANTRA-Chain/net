# Testnet Upgrade Guide: From Version v8.1.1 to v8.2.0

## Overview

- **v8.2.0 Proposal**: [Proposal Page](https://www.mintscan.io/mantra-testnet/proposals/44)
- **v8.2.0 Upgrade Block Height**: 14158888
- **v8.2.0 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/mantra-testnet/block/14158888)
- **v8.2.0 Release**: [Release Page](https://github.com/MANTRA-Chain/mantrachain/releases/tag/v8.2.0)
- **v8.2.0 Docker Image**: [ghcr.io/mantra-chain/mantrachain:v8.2.0](https://github.com/mantra-chain/mantrachain/pkgs/container/mantrachain)
...
At the designated block height, Cosmovisor will automatically upgrade to version v8.2.0.
...
1. Monitor Mantrachain until it reaches the specified upgrade block height: 14158888.
